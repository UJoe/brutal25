...
window.ker = [
  {
    ...
    def: Math.floor(40 + Math.random() * 35),
    ufo: 70,
    had: 0,
    pro: 0,
    popC: 0,
  ...
  },
  {
    ...
    x: 1,
    y: 3,
    pop: Math.floor(1300 + Math.random() * 700),
    mtn: 0,
    exp: 0,
    niv: Math.floor(5 + Math.random() * 25),
    joy: Math.floor(1 + Math.random() * 9),
  ...
  },
  {
    ...
    x: 3,
    y: 1,
    pop: Math.floor(2000 + Math.random() * 1500),
    mtn: 0,
    exp: 0,
    niv: Math.floor(0 + Math.random() * 20),
    joy: Math.floor(5 + Math.random() * 20),
  ...
  },
  {
    ...
    x: 1,
    y: 2,
    pop: Math.floor(150 + Math.random() * 300),
    mtn: 0,
    exp: 0,
  ...
  },
  {
    ...
    x: 2,
    y: 2,
    pop: Math.floor(1000 + Math.random() * 1000),
    mtn: 0,
    exp: 0,
  ...
  },
  {
    ...
    x: 3,
    y: 2,
    pop: Math.floor(900 + Math.random() * 600),
    mtn: 0,
    exp: 0,
  ...
  },
  {
    ...
    x: 2,
    y: 1,
    pop: Math.floor(200 + Math.random() * 500),
    mtn: 0,
    exp: 0,
    niv: Math.floor(5 + Math.random() * 25),
    joy: Math.floor(25 + Math.random() * 50),
    def: Math.floor(35 + Math.random() * 35),
    ufo: 50,
    had: 0,
    pro: 0,
    popC: 0,
    ...
    devdum: ["Egy kalap szart sem ér ez ", "Csuda jó dolog ez "]
  },
  {
    num: 7,
    name: "Lakónegyed",
    ...
    x: 2,
    y: 3,
    pop: Math.floor(2222 + Math.random() * 1234),
    mtn: 0,
    exp: 0,
  ...
  },
  {
    ...
    x: 3,
    y: 3,
    pop: Math.floor(750 + Math.random() * 500),
    mtn: 0,
    exp: 0,
    ...
    semmi: [
      ...
      "Liszt volt a jobb zongorista! Ő kapásból el tudta játszani Chopin darabjait, míg fordítva ez nem volt mindig igaz!",
